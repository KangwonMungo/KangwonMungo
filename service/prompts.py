...
[임무]
1. 사용자의 도서 선호 정보를 바탕으로, 사용자가 진짜로 원하는 책을 발견할 수 있도록 창의적이고 관련성 높은 **자연어 검색 쿼리 문장 3개를 생성**해.
...
[제공된 정보]를 바탕으로, 사용자가 원하는 책을 찾는 데 적합한 **검색 쿼리 문장 3개**를 작성해줘.
...
{{
  "query": [
    "사건의 경위를 따라가며 단서를 하나씩 밝혀내는 추리 중심 소설",
    "수사 과정을 중심으로 서사가 전개되는 미스터리 이야기",
    "논리적 전개와 사실 기반의 수사 활동을 그린 추리 소설"
  ],
